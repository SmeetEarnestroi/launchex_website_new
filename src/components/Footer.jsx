    ...
    return (
        <footer className="bg-white border-t border-slate-100 pt-24 pb-12 overflow-hidden">
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-16 mb-24">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <div className="flex gap-4">
                            <Twitter className="w-5 h-5 text-slate-300 hover:text-primary-600 cursor-pointer transition-colors" />
                            <Instagram className="w-5 h-5 text-slate-300 hover:text-primary-600 cursor-pointer transition-colors" />
                            <Mail className="w-5 h-5 text-slate-300 hover:text-primary-600 cursor-pointer transition-colors" />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-[13px] font-bold text-slate-400">
                            ...
                            <li><a href="#" className="hover:text-primary-600 transition-colors">Earn LaunchEx</a></li>
                            <li><a href="#" className="hover:text-primary-600 transition-colors">Transparency</a></li>
                            <li><a href="#" className="hover:text-primary-600 transition-colors">Roadmap</a></li>
                            <li><a href="#" className="hover:text-primary-600 transition-colors">LaunchEx Whitepaper</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-[13px] font-bold text-slate-400">
                            <li><a href="#" className="hover:text-primary-600 transition-colors">Developers</a></li>
                            ...
                            <li><a href="#" className="hover:text-primary-600 transition-colors">About Prex Markets</a></li>
                        </ul>
                    </div>
                ...
                {/* Bottom Bar */}
                <div className="pt-1 border-t border-slate-50 flex flex-col md:row items-center justify-between gap-6">
                    <p className="text-[10px] font-bold text-slate-400">
                        © 2026 LaunchEx. All rights reserved.
                    </p>
                    <div className="flex items-center gap-3">
                        <div className="px-3 py-1 bg-primary-50 rounded-full flex items-center gap-2 border border-primary-100">
                            <div className="w-1.5 h-1.5 bg-primary-600 rounded-full animate-pulse"></div>
                            <span className="text-[10px] font-black text-primary-700 uppercase tracking-widest">LaunchEx</span>
                        </div>
                        <p className="text-[10px] font-bold text-slate-400">LaunchEx is an algorithmic treasury-backed token</p>
                    </div>
                </div>
