    ...
    return (
        <>
            <nav className={`fixed w-full z-50 transition-all duration-500 ${
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center">
                        ...
                        >
                            <img src={Logo} alt="Logo" className="h-14 transition-transform duration-300 group-hover:scale-105" />
                        </div>
            ...
            <div className={`fixed inset-0 z-40 transition-all duration-500 ${
                ...
                {/* Slide Drawer */}
                <div className={`absolute top-0 right-0 h-full w-[80%] max-w-sm bg-white dark:bg-slate-950 shadow-2xl transform transition-transform duration-500 ${
