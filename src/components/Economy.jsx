...
const Economy = () => {
    ...
    WHY SECTION - MODERN
=========================== */}
<section className="relative py-24 overflow-hidden" id='economy'>
  {/* Background Gradient */}
  <div className="absolute inset-0 bg-linear-to-b from-white via-blue-50/40 to-purple-50/40 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950" />
  ...
  <div className="relative max-w-6xl mx-auto px-6">
    ...
    <div className="text-center mb-20">
      <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white">
        Why Most Meme Coin Launches{" "}
        <span className="bg-linear-to-r from-[#60a5fa] to-[#7c3aed] bg-clip-text text-transparent">
          Fail
        </span>
      </h2>
      <p className="mt-6 text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
        Bots dominate. Liquidity disappears. Retail becomes exit liquidity.
        LaunchEx changes the game.
      </p>
    </div>
    ...
    <div className="grid md:grid-cols-2 gap-10 lg:gap-16">
      ...
      <div className="space-y-8">
        {/* Card 1 */}
        <div className="group bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl border border-gray-200 dark:border-gray-800 rounded-2xl p-6 hover:shadow-2xl transition-all duration-300">
          <div className="flex gap-4 items-start">
            <div className="w-12 h-12 flex items-center justify-center rounded-xl bg-blue-500/10 text-2xl">
              🎁
            </div>
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                Get <span className="font-semibold text-blue-500">1,000 FREE LaunchEx tokens</span> when you sign up.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="group bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl border border-gray-200 dark:border-gray-800 rounded-2xl p-6 hover:shadow-2xl transition-all duration-300">
          <div className="flex gap-4 items-start">
            <div className="w-12 h-12 flex items-center justify-center rounded-xl bg-purple-500/10 text-2xl">
              💬
            </div>
            <div>
              <h4 className="text-lg font-semibold text-gray-900 dark:text-white">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                Earn <span className="font-semibold text-purple-500">2,000 tokens</span> for every referral.
        ...
        <div className="group bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl border border-gray-200 dark:border-gray-800 rounded-2xl p-6 hover:shadow-2xl transition-all duration-300">
          <div className="flex gap-4 items-start">
            ...
            <div>
              <h4 className="text-lg font-semibold text-gray-900 dark:text-white">
                Earn From Meme Coin Trading
              </h4>
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                Active users unlock trading fee rewards on every meme coin
                launched and traded on LaunchEx.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="space-y-8">
        {/* Fixes Card */}
        <div className="bg-linear-to-br from-[#60a5fa]/10 to-[#7c3aed]/10 border border-blue-400/20 rounded-2xl p-8 backdrop-blur-xl">
          <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-6">
            LaunchEx Fixes This — By Design
          </h4>

          <ul className="space-y-4">
            {[
              "Exchange-controlled liquidity",
              "No mempool sniping",
              "Human-only trading",
              "AI-assisted fairness",
            ].map((item, index) => (
              <li key={index} className="flex items-center gap-3 text-gray-700 dark:text-gray-300">
                <div className="w-6 h-6 flex items-center justify-center rounded-full bg-green-500/20 text-green-500 text-sm font-bold">
                  ✓
                </div>
                {item}
              </li>
...
<section className="relative py-28 overflow-hidden">
  <div className="absolute inset-0 bg-linear-to-b from-white to-gray-100 dark:from-gray-950 dark:to-black" />
  <div className="absolute inset-0 bg-linear-to-r from-[#60a5fa]/10 to-[#7c3aed]/10 blur-3xl" />
  ...
  <div className="relative max-w-4xl mx-auto text-center px-6">
    ...
    <p className="mt-6 text-lg text-gray-600 dark:text-gray-400">
      LaunchEx rewards early belief — not bots.
    </p>
    ...
    <div className="mt-12 flex flex-wrap justify-center gap-8 text-sm text-gray-500 dark:text-gray-400">
      {["Secure & Audited", "24/7 Support", "10K+ Early Believers"].map((item, i) => (
